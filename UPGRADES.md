...
- `[planned]` 2026-08-06 — Restore thin-client ambient collection: a `JARVIS_MODE=client` collector job on the Mac that feeds the outbox → server (STATUS priority #4); plus enable `JARVIS_TOKEN` end-to-end (box + Mac `~/.zshrc`)
